...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
    	...
    	// You may use the code if:
        // - You wrote it yourself or with your teammates (for team projects).
        ...
        // - It is required for the current assignment.
        if (implementationRequired) {
            return true;
        }

        // - You properly cite your source when using external code.
